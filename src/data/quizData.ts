    ...
    questions: [
      {
        id: 'q_iii1',
        type: 'multiple',
        question: 'Мама дома? — Да, ___ дома.',
      ...
      },
      {
        id: 'q_iii2',
        type: 'multiple',
        question: 'Где велосипед? — Вот ___.',
        options: ['он', 'она', 'оно', 'они'],
        correctAnswer: '1',
      },
      {
      ...
      },
      {
        id: 'q_iii4',
        type: 'multiple',
        question: 'Письмо у тебя? — Да, вот ___ .',
        options: ['он', 'она', 'оно', 'они'],
        correctAnswer: '3',
  },
  {
      ...
      },
      {
        id: 'q_iii6',
        type: 'multiple',
        question: 'Где дядя? — ___ на балконе.',
        options: ['он', 'она', 'оно', 'они'],
        correctAnswer: '1',
      },
      {
        id: 'q_iii7',
        type: 'multiple',
        question: 'Дверь справа? — Нет, ___ слева.',
        options: ['он', 'она', 'оно', 'они'],
        correctAnswer: '2',
      },
      {
      ...
      },
      {
        id: 'q_iii9',
        type: 'multiple',
        question: 'Овощи и фрукты на столе? — Да, ___ на столе.',
        options: ['он', 'она', 'оно', 'они'],
        correctAnswer: '4',
      },
      {
        id: 'q_iii10',
        type: 'multiple',
        question: 'Аудитория на первом этаже? — Нет, ___ на третьем этаже.',
        options: ['он', 'она', 'оно', 'они'],
        correctAnswer: '2',
      },
    ],
